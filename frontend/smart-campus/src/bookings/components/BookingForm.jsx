...
function BookingForm({ onBookingCreated }) {
  ...
  return (
    <section className="mx-auto w-full max-w-3xl rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
      <div className="mb-6">
        <h2 className="text-2xl font-bold tracking-tight text-slate-900">Create a Booking</h2>
        <p className="mt-2 text-sm text-slate-600">
          Reserve a campus resource by selecting a date, time slot, and booking details.
        </p>
      </div>
